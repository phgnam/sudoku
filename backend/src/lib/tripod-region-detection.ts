/**
 * Tripod Region Detection Utility (Backend)
 * Shared algorithm for detecting connected regions using BFS
 * 
 * NOTE: This file is duplicated from frontend/lib/tripod-region-detection.ts
