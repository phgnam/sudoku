...
import { MatchManagerService, MatchService, EloService, MatchmakingService } from './services';

@Module({
  imports: [TypeOrmModule.forFeature([Match, Puzzle, User])],
  providers: [MatchManagerService, MatchService, EloService, MatchmakingService],
